...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://raw.githubusercontent.com/HawkOG/CSS-Library/master/master.css">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link " href="http://localhost/egzaminas/public/index">
                  <i class="material-icons">edit</i>
                  <span>Customer Feedback</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="http://localhost/egzaminas/public/create_employee">
            ...
            <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
              ...
              <ul class="navbar-nav border-left flex-row ml-auto">
                ...
                <li class="nav-item dropdown">
                  ...
                  <span class="d-none d-md-inline-block">xxx_Skerdejas_xxx</span>
                  </a>
